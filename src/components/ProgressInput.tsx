    ...
    return (
        <View
            ...
            {options.map((option, index) => (
                <Fragment>
                    {index == 0 ? null : <View key={`track-${index}`} style={{ flex: 1, backgroundColor: Resources.get().getColors().Black, height: trackPadHeight, marginTop: circlesDiameter / 2 - trackPadHeight / 2 }} />}
